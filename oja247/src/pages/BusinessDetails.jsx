      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-16 sm:-mt-20 relative z-10">
        <div className="bg-white rounded-2xl shadow-lg p-5 sm:p-8 flex flex-col sm:flex-row items-center sm:items-start gap-5 sm:gap-6 text-center sm:text-left">
          <img
            ...
            alt={business.name}
            className="w-28 h-28 sm:w-32 sm:h-32 rounded-full border-4 shadow-xl object-cover flex-shrink-0"
              ...
              >
                ...
                <div className="p-3 sm:p-4 flex flex-col flex-1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 w-full text-center bg-green-500 hover:bg-green-600 text-white py-2 rounded-lg text-sm sm:text-base font-medium transition-colors"
                  >
                    <svg
